...
SieveSaslPlainRequest.prototype.addResponse
    = function (data)
{
	globalServices.logSrv( this.toString() + " " + this.responseListener + " " + this.errorListener + " addResponse, data: " + data );
  var response = new SieveInitResponse(data); //SieveSaslPlainResponse
